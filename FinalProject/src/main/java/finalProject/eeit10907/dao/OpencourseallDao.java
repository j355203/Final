...
public interface OpencourseallDao {
	...
	public String opencourseall_Q3(String[] subjectID) throws IOException, SQLException; //下拉查學門細節
	public String opencourseall_Q4() throws IOException, SQLException; //第一個學門總攬
	...
	public String opencourseall_Q10() throws IOException, SQLException; //查詢課程總攬
