...
public interface OpensourseDao {
	//開放資源

	
	public String opensourse_U1_T(String UpbullImg,String UpbullImgUrl) throws SQLException;  //修改公告
	public String opensourse_U2_T(String [] bullsU2) throws SQLException;//上船公告一的標題 內容
	public String opensourse_U3_T(String UpbullImg,String UpbullImgUrl) throws SQLException;  //修改公告
