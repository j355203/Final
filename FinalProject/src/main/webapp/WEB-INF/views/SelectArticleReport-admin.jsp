		...
		<div class="container-fluid mt--8">
			...
			<div class="row">
				...
				<div class="col-lg-2" style="margin-top: 136px;margin-left: 90px;">
					<input id="reportPass" style="margin-bottom: 16px;" class="btn btn-secondary" type="button"
						value="審查通過" />
					<input id="reportUnPass" style="margin-bottom: 16px;" class="btn btn-danger" type="button"
						value="審查不通過" />
