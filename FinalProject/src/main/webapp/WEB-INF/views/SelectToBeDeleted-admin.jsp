...
<body>
	...
	<div class="main-content">
		...
		<div class="container-fluid mt--7">
			...
			<input class="btn btn-success" type="button" value="通過審核之檢舉"
				onclick="location.href='<spring:url value='SelectExamined-admin' />'"
				style="background-color: #2828FF;border: #2828FF;" />
			<input class="btn btn-danger" type="button" value="未通過審核待刪除" onclick="location.href=''"
						...
						<tbody class="list">
							<c:forEach items="${AB}" var="AB" varStatus="s">
								<tr>
									...
									<td>
										<a href="<spring:url value='/SelectArticleToBeDeleted-admin?articleId=${AB.articleId}' />"
