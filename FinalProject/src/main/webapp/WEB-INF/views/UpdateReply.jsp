		...
		<div class="container-fluid mt--8">
			...
			<div class="row">
				<div class="row justify-content-md-center">
					<div class="col-lg-10">
						<form:form method="POST" modelAttribute="UpdateReply">
							<fieldset>
								<!-- <legend>修改討論文章</legend> -->
								<div class="fr1">
									<label for="class" class="lab1">回覆文章：</label>
									<input type="hidden" value="${RB.articleId}" name="articleId" path="articleId"
										readonly />
									<input type="hidden" value="${RB.replyId}" name="replyId" path="replyId" readonly />
									<input type="hidden" value="${RB.replyDate}" name="replyDate" path="replyDate"
										readonly />
									<input type="hidden" value="${RB.empName}" name="empName" path="empName"
										readonly />
								...
								<div class="fr1">
									...
									<textarea class="form-control form-control-alternative" cols="55" rows="30"
										id="article" name="replyContent"
										path="replyContent">${RB.replyContent}</textarea>
