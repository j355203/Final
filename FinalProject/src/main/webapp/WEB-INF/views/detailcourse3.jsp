				...
				<section class="section02">
					...
					<form>
						...
						<table class="tb1" id="ttt">
							<tr class="tr01">
								<td
									style="font-weight: bolder; background-color: #B8B8DC; font-weight: bolder"
									colspan="4"></td>
							</tr>
							<tr>
...
<script>
	$(function() {
		...
		empid = $("#empid_in", window.opener.document).val(); //抓取前一頁的ID
	})
</script>
				...
				function showNames(data) {
					...
					for (var i = 0; i < data.length; i++) {
						str = str + "<tr class='tr01'>"
								...
								+ data[i].SubjectName + "</td>" + "</tr>"
								+ "<tr class='tr02'>"
								+ "<td style='width: 10%'>課程名稱</td>"
								+ "<td style='width: 10%;' colspan='3'>"
								+ data[i].CourseName + "</td>" + "</tr>"
								+ "<tr class='tr02'>"
								+ "<td style='width: 10%'>學分</td>"
								+ "<td style='width: 10%;'>" + data[i].Credits
								+ "</td>" + "</tr>" + "<tr class='tr02'>"
								+ "<td style='width: 10%'>上課教室</td>"
								+ "<td style='width: 10%;'>" + data[i].RoomName
								+ "</td>" + "</tr>" + "<tr class='tr02'>"
								+ "<td style='width: 10%'>開始時間</td>"
								+ "<td style='width: 10%;'>"
								+ data[i].StartDateTime + "</td>" + "</tr>"
								+ "<tr class='tr02'>"
								+ "<td style='width: 10%'>結束時間</td>"
								+ "<td style='width: 10%;'>"
								+ data[i].EndDateTime + "</td>" + "</tr>"

								+ "<tr class='tr02'>"
								+ "<td style='width: 10%'>概要</td>"
								+ "<td style='width: 10%;' colspan='3'>"
								+ data[i].CourseSummary + "</td>" + "</tr>"
					}
					$("#ttt").html(str)
				}
