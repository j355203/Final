...
<link href="${pageContext.request.contextPath}/css/eeit10907/index2.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/css/eeit10907/de_main.css"
	rel="stylesheet">
<style>
* {
	font-family: "微軟正黑體";
				...
				<section class="section02">
					...
					<form>
						...
						<table class="tb1" id="ttt">
							<tr class="tr01">
								<td style="width: 8%; font-weight: bolder;">學門</td>
								<td style="width: 15%; font-weight: bolder;">課程名稱</td>
								<td style="width: 5%; font-weight: bolder;">學分</td>
								<td style="width: 10%; font-weight: bolder;">講師<br>教學邏輯性
								</td>
								<td style="width: 10%; font-weight: bolder;">講師<br>分析問題講解
								</td>
								<td style="width: 11%; font-weight: bolder;">課程<br>內容實務導向性
								</td>
								<td style="width: 10%; font-weight: bolder;">課程<br>資料實用性
								</td>
								<td style="width: 8%; font-weight: bolder;">講師<br>總體評價
								</td>
								<td style="width: 8%; font-weight: bolder;">課程<br>總體評價
								</td>
								<td style="width: 8%; font-weight: bolder;">總體評價</td>
								<td style="width: 5%; font-weight: bolder;">是否<br>完成
								</td>
							</tr>

						</table>
						<br>
						<table class="tb1" id="score">
							<tr class="tr01">
								<td style="font-weight: bolder;" colspan="4">總修課學分</td>
							</tr>
						</table>
						<br>
...
<script>
	$(function() {
		empid = $("#EmployeeID_in", window.opener.document).val(); //抓取前一頁的ID
	})
</script>
<script>
...
<%-- 我的學分使用 --%>
	$(document)
			.ready(
					function() {
						empid = $("#EmployeeID_in", window.opener.document)
								.val();//取得前一頁的值
						console.log(empid);
						a(empid);
						function a(empid) {
							$
									.ajax({
										url : "${pageContext.request.contextPath}/employee/Q4",
										data : {
											empid : empid
										},
										type : "GET",
						...
						function showNames(data) {
							...
							var str = "<tr class='tr01'>"
									...
									+ "<td style='width: 10%'> 講師<br>教學邏輯性</td>"
									+ "<td style='width: 10%'> 講師<br>分析問題講解</td>"
									+ "<td style='width: 11%'> 課程<br>內容實務導向性</td>"
									+ "<td style='width: 10%'> 課程<br>資料實用性</td>"
									+ "<td style='width: 8%'> 講師<br>總體評價</td>"
									+ "<td style='width: 8%'> 課程<br>總體評價</td>"
									+ "<td style='width: 8%'> 總體評價</td>"
									+ "<td style='width: 5%'>是否完成</td>"
									+ "</tr>"
							for (var i = 0; i < data.length; i++) {
								str = str + "<tr class='tr02'>"
										+ "<td style='display:none;'><hidden>"
										+ data[i].CourseID + "</hidden ></td>"
										+ "<td style='width: 8%;'>"
										...
										+ data[i].ContentQ2 + "</td>"
										+ "<td style='width: 8%;'>"
										+ data[i].MySatisTeacher + "</td>"
										+ "<td style='width: 8%;'>"
										+ data[i].MySatisContent + "</td>"
										+ "<td style='width: 8%;'>"
										+ data[i].MySatisfaction + "</td>"
										+ "<td style='width: 8%;'>"
										+ data[i].statu + "</td>" +

										"</tr>"
								var sc = parseInt(data[i].Credits)
								num = num + sc;
							}
							console.log(num);
							var out_score = "<tr class='tr01'>"
									+ "<td style='font-weight:bolder;' colspan='4'>總修課學分 </td>"
									+ "</tr>"
									+ "<tr >"
									+ "<td style='font-weight:bolder' colspan='4'>"
									+ num + "</td>" + "</tr>";

							$("#ttt").html(str);
							$("#score").html(out_score);
						}
					});
</script>
</html>