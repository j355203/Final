		...
		<div class="container-fluid mt--7"
			...
			<div class="row justify-content-md-center">
				...
				<section class="section03">
					...
					<div class="title3">課程系統</div>
					<div>

						<span class="bottonspan02"> <a
							href="${pageContext.request.contextPath}/selectcourse">
								<button class="bottonstyle01" type="button" value="select">選課系統
									&gt;</button>
						</a>
						</span>
					</div>
			...
			<section class="section02">
				<br>
				<div class="title1">我的學分</div>
				<table class="tb1" id="ttt1">

					<tr class="tr01">
						<td style="width: 50%">學門名稱</td>
						<td style="width: 25%">學分數</td>
					</tr>
					<tr>
						<td>學門名稱</td>
						<td>學分數</td>
...
<%-- 刪除課程 --%>
	function ShowMeDate() {
		...
		var empid = (data[0].cells[0].textContent);//把資料存起來
		var CourseID = (data[0].cells[1].textContent);
		aaa(empid, CourseID);

		function aaa(empid, CourseID) {
	...
	$(document)
			.ready(
					function() {
						function a() {
							$.ajax({
								url : "${pageContext.request.contextPath}/Q1",
								data : {
									empid : 1001
								},
								type : "POST",
						...
						function showNames(data) {
							...
							for (var i = 0; i < data.length; i++) {
								str = str
										...
										+ data[i].CourseName
										+ "</td>"
										+ "<td><a href='${pageContext.request.contextPath}/detailcourse?empid="
										+ data[i].empid
										+ "&CourseID="
										+ data[i].CourseID
										...
										+ "onclick='ShowMeDate()'>取消報名</button></td>"
										+ "</tr>"
...
<%-- 秀出學門學分--%>
	function b() {
							$.ajax({
								url : "${pageContext.request.contextPath}/Q3",
								data : {
									empid : 1001
						...
						function showNames1(data) {
							var str = "<tr class='tr01' >"

							+ "<td style='width: 10%'>學門</td>"
									+ "<td style='width: 15%'>學分</td>"
									+ "<td style='width: 15%'>已修學分</td>"
									+ "</tr>";
							for (var i = 0; i < data.length; i++) {
								str = str + "<tr>"

								+ "<td>" + data[i].SubjectName + "</td>"
										+ "<td>" + data[i].SubjectScore
										+ "</td>" + "<td>" + data[i].countstatu
										+ "</td>" + "</tr>";
								console.log("asdasd");//data[i].CourseName    
							}
							$("#ttt1").html(str)
						}
						b();
